...
//! DATE: 2023-11-26, STEPS: `50`, REPEAT: `20`, LOW RANGE: `[]`, HIGH RANGE: `[]`
...
impl<T: frame_system::Config> pallet_reward::WeightInfo for WeightInfo<T> {
	...
	fn reward() -> Weight {
		...
		Weight::from_parts(19_808_000, 0)
	...
	fn process_evaluation_queue(i: u32, ) -> Weight {
		...
		Weight::from_parts(4_676_088, 0)
			.saturating_add(Weight::from_parts(0, 3201489))
			// Standard Error: 28
			.saturating_add(Weight::from_parts(652, 0).saturating_mul(i.into()))
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	/// Storage: `Reward::AccountQueue` (r:1 w:0)
